        ...
        <div class="l">
          <div class="co12-g">
            ...
            ">
              ...
              <b><i class="wf wf-cog Taler f20"></i> CONFIGURÁVEL:</b>
          ...
          <div class="co6-g">
            ...
            <div class="btns">
              <button
                ...
                onclick="WfAjax.load({url: '../blocosTestes/teste-ajax-1.html', dest: 'ajaxContent01', effect: 'fade'})">
                Fade
              </button>
              <button
                class="btn btnajax Bazul9 Tbran"
                onclick="WfAjax.load({url: '../blocosTestes/teste-ajax-2.html', dest: 'ajaxContent01', effect: 'fadeLeft'})">
                FadeLeft
              </button>
              <button
                class="btn btnajax Bazul8 Tbran"
                onclick="WfAjax.load({url: '../blocosTestes/teste-ajax-3.html', dest: 'ajaxContent01', effect: 'fadeRight'})">
                FadeRight
              </button>
              <button
                class="btn btnajax Bazul7 Tbran"
                onclick="WfAjax.load({url: '../blocosTestes/teste-ajax-1.html', dest: 'ajaxContent01', effect: 'fadeTop'})">
                FadeTop
              </button>
              <button
            ...
            <div class="btns">
              ...
              <button
                class="btn btnajax Bazul10 Tbran"
                WfAjax
                WfAjax-url="../blocosTestes/teste-ajax-1.html"
              ...
              <button
                class="btn btnajax Bazul9 Tbran"
                WfAjax
                WfAjax-url="../blocosTestes/teste-ajax-2.html"
                WfAjax-dest="ajaxContent01"
              ...
              <button
                class="btn btnajax Bazul8 Tbran"
                WfAjax
                WfAjax-url="../blocosTestes/teste-ajax-3.html"
                WfAjax-dest="ajaxContent01"
        ...
        <div class="l">
          <div class="co12-g">
            ...
            <div
              ...
              color: var(--wf-color);
            ">
              <b><i class="wf wf-wrench Taler f20"></i> TODOS OS 48 COMPONENTES
                SUPORTADOS:</b>
              ...
              <b><i class="wf wf-cloud-lightning Taler f20"></i>
                FUNCIONAMENTO:</b>
              Após carregar conteúdo AJAX, TODOS os componentes são inicializados
              automaticamente<br />
              <b><i class="wf wf-target-lock Taler f20"></i> RESULTADO:</b>
          ...
          <div class="co6-g">
            ...
            ">
              ...
              ">
                ...
                <small><b>Fade (5):</b> fade, fadeLeft, fadeRight, fadeTop,
                  fadeBottom<br />
