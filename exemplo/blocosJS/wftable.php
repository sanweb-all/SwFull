        ...
        <div class="l">
          <div class="co12-g">
            ...
            <div
              ...
              color: var(--wf-color);
            ">
              <b><i class="wf wf-table Taler f20"></i> FUNCIONALIDADES:</b>
              Ordenação, filtros, paginação, busca, exportação<br />
              <b><i class="wf wf-search Taler f20"></i> BUSCA INTELIGENTE:</b>
              ...
              <b><i class="wf wf-moon Taler f20"></i> TEMA DIA/NOITE:</b>
              Integração automática com WfDay<br />
              <b><i class="wf wf-download Taler f20"></i> EXPORTAÇÃO:</b>
  ...
  <table class="wftable">
    ...
    <tbody>
      <tr>
        ...
        <td><span WfBadge class="wfbadge-prin">Ativo</span></td>
        <td>
          <button class="btn btn-p btn-prin">Editar</button>
          <button class="btn btn-p btn-peri">Excluir</button>
        </td>
      </tr>
    </tbody>
  </table>
  ...
  <!-- Conteúdo da tabela -->
        ...
        <div class="l">
          <div class="co12-g">
              ...
              <table class="wftable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>(11) 88888-8888</td>
                    <td><span WfBadge class="wfbadge-aler">Pendente</span></td>
                    <td>
                      <button class="btn btn-p btn-prin">Editar</button>
                      <button class="btn btn-p btn-peri">Excluir</button>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>(11) 77777-7777</td>
                    <td><span WfBadge class="wfbadge-peri">Inativo</span></td>
                    <td>
                      <button class="btn btn-p btn-prin">Editar</button>
                      <button class="btn btn-p btn-peri">Excluir</button>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>(11) 55555-5555</td>
                    <td><span WfBadge class="wfbadge-info">Novo</span></td>
                    <td>
                      <button class="btn btn-p btn-prin">Editar</button>
                      <button class="btn btn-p btn-peri">Excluir</button>
                    </td>
            ...
            <p>
              <small><i class="sw sw-search wdest2-color f20"></i> Use a busca •
...
<div WfTable
     ...
     WfTable-draggable="true">      <!-- Arrastar e soltar -->
          ...
          <div class="co6-g">
            ...
            <p>
              <small><i class="sw sw-smartphone wdest2-color f20"></i> Responsivo •
...
.wftable-sortable          /* Coluna ordenável */
          ...
          <div class="co6-g">
            ...
            <div
              ...
              WfTable-sort="true"
              WfTable-pagination="true"
              style="--wftable-prin: #e74c3c; --wftable-secondary: #ecf0f1">
              <table class="wftable">
                <thead>
                  <tr>
                    <th>Nome</th>
            ...
            <p>
              <small><i class="sw sw-palette wdest2-color f20"></i> Tema personalizado
                com cores vermelhas •
                <i class="sw sw-search wdest2-color f20"></i> Busca •
                <i class="sw sw-bar-chart-2 wdest2-color f20"></i> Ordenação •
...
WfTable.exportPDF(tableElement);      // Exporta para PDF
          ...
          <div class="co6-g">
            ...
            <div style="margin: 15px 0">
              <button onclick="testarMetodos()" class="btn btn-prin">
                Testar Métodos
              </button>
        ...
        <div class="l">
          ...
          <div class="co6-g">
            ...
            <div
              ...
              color: var(--color);
            ">
              <b><i class="sw sw-keyboard wdest2-color f20"></i> Navegação por
                Teclado:</b><br />
