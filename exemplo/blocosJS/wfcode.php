      ...
      <div class="l">
         <div class="co12-g">
            ...
            <div style="background: var(--wf-bg-); padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #2196f3; color: var(--wf-color)">
               <h3 style="margin-top: 0"><i class="wf wf-bulb Taler f20"></i> Formatos Aceitos:</h3>
               <p>O WfCode aceita <b>DOIS formatos</b> para especificar a linguagem:</p>
               <ul style="color: var(--wf-color)">
                  <li><code>WfCode-language="php"</code> - Formato completo (recomendado)</li>
                  <li><code>WfCode-lang="php"</code> - Formato abreviado</li>
               </ul>
               <p><b>Ambos funcionam perfeitamente!</b> Use o que preferir.</p>
            </div>
...
<body>
  ...
  <script src="swfull.js"><\/script>
      ...
      <div class="l">
         <div class="co4-g">
            <h3>CSS</h3>
            <pre WfCode WfCode-language="css"><script type="text/plain">
...
.btn:hover {
  ...
  transform: translateY(-2px);
         ...
         <div class="co4-g">
            <h3>PHP</h3>
            <pre WfCode WfCode-language="php"><script type="text/plain">
< ?php
class Usuario {
    private $nome;
    private $email;
...
?>
         ...
         <div class="co4-g">
            <h3>JSON</h3>
            <pre WfCode WfCode-language="json"><script type="text/plain">
{
...
WfCode.initAll(container);
            ...
            <ul style="color: var(--wf-color)">
               <li><code>WfCode-language="javascript"</code> ✅ Formato completo</li>
               <li><code>WfCode-lang="php"</code> ✅ Formato abreviado</li>
               <li><code>lang="css"</code> ✅ Atributo HTML padrão</li>
               <li><code>class="language-html"</code> ✅ Classe Prism.js</li>
